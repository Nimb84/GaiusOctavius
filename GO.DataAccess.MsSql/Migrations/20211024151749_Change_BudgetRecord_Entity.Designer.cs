...
namespace GO.DataAccess.MsSql.Migrations
{
    ...
    [Migration("20211024151749_Change_BudgetRecord_Entity")]
    partial class Change_BudgetRecord_Entity
    {
            ...
            modelBuilder.Entity("GO.Domain.Entities.Budgets.Budget", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 10, 24, 15, 17, 46, 968, DateTimeKind.Unspecified).AddTicks(6066), new TimeSpan(0, 0, 0, 0, 0)),
                            IsArchived = false,
                            Payday = (byte)0
                        });
                });
            ...
            modelBuilder.Entity("GO.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("936da01f-9abd-4d9d-80c7-02af85c822a8"),
                            CreatedBy = new Guid("936da01f-9abd-4d9d-80c7-02af85c822a8"),
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 10, 24, 15, 17, 46, 963, DateTimeKind.Unspecified).AddTicks(7909), new TimeSpan(0, 0, 0, 0, 0)),
                            FirstName = "Dmytro",
                            IsArchived = false,
                            IsLocked = false,
                            LastName = "😇",
            ...
            modelBuilder.Entity("GO.Domain.Entities.Users.UserConnection", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("936da01f-9abd-4d9d-80c7-02af85c822a8"),
                            CreatedDate = new DateTimeOffset(new DateTime(2021, 10, 24, 15, 17, 46, 967, DateTimeKind.Unspecified).AddTicks(3932), new TimeSpan(0, 0, 0, 0, 0)),
                            CurrentScope = (byte)8,
                            NickName = "Nimb84",
                            Type = 1,
                            UserId = new Guid("936da01f-9abd-4d9d-80c7-02af85c822a8")
